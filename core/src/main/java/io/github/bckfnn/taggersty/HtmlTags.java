...
/**
 * HtmlBuilder is the base class of html generators. All the methods for HTML tags are
...
public class HtmlTags extends Tags {
    ...
    public HtmlTags direct(Consumer<HtmlTags> handler) {
        closeTag();
        HtmlTags nested = new HtmlTags(output);
        nested.setAutoIndent(false);
        nested.setAutoNewline(false);

        handler.accept(nested);
        state = State.CONTENT;
        return nested;
    }
